...
public class SignupActivity extends AppCompatActivity {
    ...
    private String namestr,passwordstr,emailstr,mobnostr,citystr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        city_su=findViewById(R.id.signup_city);
        ...
        signupbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                citystr=city_su.getEditText().getText().toString();
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Signuphelperclass signuphelperclass=new Signuphelperclass(namestr,emailstr,passwordstr,mobnostr,citystr);
